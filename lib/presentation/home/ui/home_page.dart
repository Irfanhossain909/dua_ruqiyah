...
class HomePage extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // Dua Cards
                    _buildDuaCard(Icons.star, 'Dua Importance', '7 Subcategories', 50, Colors.yellow, Colors.yellow[100]!, state),
                    _buildDuaCard(Icons.check_circle, 'Dua Acceptance', '10 Subcategories', 33, Colors.red[400]!, Colors.red[50]!, state),
                    _buildDuaCard(Icons.nights_stay, 'Time of Dua', '5 Subcategories', 25, Colors.indigo[400]!, Colors.indigo[50]!, state),
                    _buildDuaCard(Icons.account_balance_rounded, 'Hazz & Umrah', '9 Subcategories', 42, Colors.grey[700]!, Colors.grey[100]!, state),
                    _buildDuaCard(Icons.account_balance, 'Witr & Other', '30 Subcategories', 22, const Color(0xFF8BC34A), Colors.green[50]!, state), // Lighter green
                    _buildDuaCard(Icons.fastfood, 'Fasting', '12 Subcategories', 44, Colors.orange[400]!, Colors.orange[50]!, state),
                    _buildDuaCard(Icons.water_drop, 'Ablution & Bath', '15 Subcategories', 47, Colors.blue[400]!, Colors.blue[50]!, state),
                  ],
                ),
              ),
            ),
          ),
          bottomNavigationBar: _buildBottomNavigationBar(state, controller),
        );
      },
    );
  }
        ...
        children: [
          Expanded(
            child: Container(
              ...
              child: Center(
                child: Text('Dua', style: state.tabTextStyle.copyWith(color: const Color(0xFF8BC34A))),  // Lighter Green
              ),
            ),
          ),
          Expanded(
            child: Container(
              padding: const EdgeInsets.symmetric(vertical: 8),
              child: Center(
                child: Text('Ruqyah', style: state.tabTextStyle),
              ),
            ),
          ),
        ],
  ...
  Widget _buildBottomNavigationBar(HomeUiState state, HomePresenter controller) {
    return Container(
      decoration: const BoxDecoration(
      ...
      child: BottomNavigationBar(
        ...
        onTap: controller.onBottomNavItemSelected,
